        ...
        <div class="container-fluid">
                      ...
                      <div class="table-responsive">   
                        ...
                        <table class="table table-striped table-bordered table-hover tbl-list">
                            ...
                            <?php
                                ...
                                if(isset($_GET['sec'])){
                                    $query=mysqli_query($conn,"SELECT * FROM `list_student` WHERE `section`='".$_GET['sec']."'");
                                }else{
                                    $query=mysqli_query($conn,"select * from `list_student`");
                                }
                                while($row=mysqli_fetch_array($query)){
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['ojt_position']; ?></td>
                                        <!-- <td><?php echo $row['company_name']; ?></td>     -->
                                        <td>
                                            <a href="editStudent.php?id=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Edit</a> 
                                            <a href="#del<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                                            <?php
                                                if(!$list->CheckStudentAccount($row['id'])){
                                            ?>
                                                <a href="#create<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-warning"><span class="glyphicon glyphicon-trash"></span>Create</a>
                                            <?php
                                                }else{
                                            ?>                                            
                                                <a href="#studenchangepass<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-info"><span class="glyphicon glyphicon-trash"></span>Change Password</a>
                                            <?php
                                                }
                                            ?>
            ...
            <div class="row">
             <?php
                    if(isset($_GET['sec'])){
            ?>
                <div class="col-xs-6"><a class="btn btn-primary" href="../list_class/" data-toggle="modal" >Go Back to class list</a></div>
            <?php
                    }else{
            ?>
            ...
            <?php
                ...
                ?>
                <div class="col-xs-6"><a class="btn btn-primary" href="addStudent.php">Add New</a></div>
            </div>
            </div>
        </div>
    </body>
