        ...
        <div class="container-fluid">
            <div class="portal-content">
                ...
                <div class="row justify-content-center" style="margin-top:16px">
                    ...
                    <!-- <?php echo $session_flag_is_login; ?> -->
                </div>
                <div class="row" style="margin-top:16px">
                <?php
                    $menu_items = array(
                        array('Announcements',         'announcements_logo.png',        '../announcement/'),
                        array('Student Approval',      'approval_logo.png',             '#'),
                        ...
                        // array('Class Attendance',      'student_logo.png',              '#'),
                        array('Class List',            'class_list_logo.png',           '../list_class/'),
                        array('Student Form',          'form_logo.png',                 '../list_student/'),
                        // array('Adviser Form',          'form_logo.png',                 '#'),
                        array('Adviser Evaluation',    'evaluation_logo.png',           '#'),
                        array('Internship Evaluation', 'evaluation_logo.png',           '../student_evaluation/'),
                        array('Company Information',   'company_logo.png',              '#'),
                        array('Adviser Information',   'adviser_logo.png',              '../account_adviser/'),
                        array('Account Settings',      'account_settings_logo.png',     '#'),
