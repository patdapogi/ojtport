        ...
        if ($conn) {
            ...
            if ($rows > 0) {
                if (crypt($post_auth_pass, $out_auth_pass) == $out_auth_pass) {
                    ...
                    $_SESSION['auth_user']    = $post_auth_user;
...
<html lang="en">
    <head>
        <title>LPU OJT PORTAL - Admin Login</title>
        <meta charset="utf-8">
            ...
            <div class="portal-content">
                <div class="row">
                    <div class="col text-center">
                        <img src="./assets/images/admin_logo.png" width="96px" height="96px" />
                    </div>
                </div>
                ...
                <form action="./login_admin.php" method="POST" style="margin-top:16px">
