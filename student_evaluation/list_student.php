                            ...
                            <?php
                                ...
                                while($row=mysqli_fetch_array($query)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                                if(!$list->CheckEvaluation($row['id'])){
                                            ?>
                                                <a href="evaluation_form.php?id=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Create Evaluation</a> 
                                            <?php
                                                }else{
                                            ?>                                            
                                                <a href="evaluation_view.php?id=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-info"><span class="glyphicon glyphicon-edit"></span> View Evaluation</a> 
                                            <?php
                                                }
                                            ?>
