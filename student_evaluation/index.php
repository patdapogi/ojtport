        ...
        <div class="container-fluid">
            <div class="portal-content">
                <div class="row justify-content-center">
                    <img src="../assets/images/evaluation_logo.png" width="96px" height="96px" />
                </div>
                <div class="row justify-content-center" style="margin-top:16px">
                    <p class="h3">Student evaluation per section</p>
                </div>
                    ...
                    <div class="container">
                      <div class="table-responsive">   
                        ...
                        <table class="table table-striped table-bordered table-hover tbl-list">
                            ...
                            <?php
                                include('../conn.php');
                                $query=mysqli_query($conn,"select * from `list_section`");
                                while($row=mysqli_fetch_array($query)){
                                    ...
                                    <tr>
                                        ...
                                        while($row1=mysqli_fetch_array($query1)){
                                         ...
                                         ?></td>
                                        <td>
                                            <a href="list_student.php?sec=<?php echo $row['section']; ?>" data-toggle="modal" class="btn btn-info"><span class="glyphicon glyphicon-edit"></span> View Student List</a> 
