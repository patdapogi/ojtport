        ...
        <div class="container-fluid">
            <div class="portal-content">
                ...
                <div class="row justify-content-center" style="margin-top:16px">
                    <p class="h3">OJT Attendance per section</p>
                </div>
                                ...
                                while($row=mysqli_fetch_array($query)){
                                    ...
                                    <tr>
                                        ...
                                        while($row1=mysqli_fetch_array($query1)){
                                         ...
                                         ?></td>
                                        <td>
                                            <a href="list_student.php?sec=<?php echo $row['section']; ?>" data-toggle="modal" class="btn btn-info"><span class="glyphicon glyphicon-edit"></span> View Student Attendance</a> 
