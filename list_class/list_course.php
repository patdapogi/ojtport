                    ...
                    <div class="container">
                      <div class="table-responsive">   
                        ...
                        <table class="table table-striped table-bordered table-hover tbl-list">
                            ...
                            <tbody>
                            <?php
                                $query=mysqli_query($conn,"select * from `list_class` where `dept_id`='".$_GET['id']."'");
                                while($row=mysqli_fetch_array($query)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="list_class.php?id=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-info"><span class="glyphicon glyphicon-edit"></span> Check Section</a> 
