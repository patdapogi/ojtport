...
<?php include('function.php'); ?>
    ...
    <body background="../assets/images/portal_bg.png">
        ...
        <div class="container-fluid">
                    ...
                    <div class="container">
                      <div class="table-responsive">   
                        ...
                        <table class="table table-striped table-bordered table-hover tbl-list">
                            ...
                            <tbody>
                            <?php
                                // $query=mysqli_query($conn,"select * from `list_class`");
                                $query=mysqli_query($conn,"select * from `types_departments`");
                                while($row=mysqli_fetch_array($query)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="list_course.php?id=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-info"><span class="glyphicon glyphicon-edit"></span> Check Course</a> 
            ...
            <div class="row">
                <?php
                    if($session_id_user_type==3){

                    }
                ?>
                <div class="col-xs-6"><a class="btn btn-primary" href="../" data-toggle="modal" >Go Back</a></div>
                <div class="col-xs-6"><a class="btn btn-primary" href="#addnewdept" data-toggle="modal" >Add New</a></div>
            </div>
