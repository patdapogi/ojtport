                      ...
                      <div class="table-responsive">   
                        ...
                        <table class="table table-striped table-bordered table-hover tbl-list">
                            ...
                            <?php
                                ...
                                $query=mysqli_query($conn,"select * from `account_adviser`");
                                while($row=mysqli_fetch_array($query)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- <a href="#changepass<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> Change Pass</a>  -->
                                            ...
                                            ?>
                                                <a href="#createadviser<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-warning"><span class="glyphicon glyphicon-trash"></span>Create</a>
                                            <?php
                                                }else{
                                            ?>                                            
                                                <a href="#changepass<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-info"><span class="glyphicon glyphicon-trash"></span>Change Password</a>
                                            <?php
                                                }
                                            ?>
