...
class Login{
			...
			public function LoginAuthStudent($auth_user,$auth_pass){
				...
				$sql = "Select * from account_student where auth_user = :auth_user and auth_pass = :auth_pass";
			...
			public function GetIdStudent($auth_user,$auth_pass){
					if(!$this->OpenDB()){
						error_log("OPEN DB ERROR!");
						return false;
					}
