                      ...
                      <div class="table-responsive">   
                        ...
                        <table class="table table-striped table-bordered table-hover tbl-list">
                            <thead>
                                ...
                                <th>Company name</th>
                                <th>Industry</th>
                                <th>Position Offer</th>
                            </thead>
                            <tbody>
                            <?php
                                $query=mysqli_query($conn,"select * from `list_offers` where `status`='recommended'");
                                while($row=mysqli_fetch_array($query)){
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                        <td>
                                            <a href="#view<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-info"><span class="glyphicon glyphicon-edit"></span> View Offer</a> 
                                        </td>
                                        <?php
                                            }
                                        ?>
                    ...
                    <div class="container">
                      <div class="table-responsive">   
                        ...
                        <table class="table table-striped table-bordered table-hover tbl-list">
                            ...
                            <tbody>
                            <?php
                                $query=mysqli_query($conn,"select * from `list_offers` where `status`='external'");
                                while($row=mysqli_fetch_array($query)){
                                    ?>
                                    <tr>
                                        <!-- <td><?php echo $row['id']; ?></td> -->
